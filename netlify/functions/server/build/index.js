...
// app/tailwind.css
var tailwind_default = "/build/_assets/tailwind-SO4HF53P.css";
...
function Speaking() {
  ...
  }, !events.speakingEvents.length && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(SkeletonLoader, null), /* @__PURE__ */ React.createElement(SkeletonLoader, null), /* @__PURE__ */ React.createElement(SkeletonLoader, null)), events.speakingEvents.map((event, i) => /* @__PURE__ */ React.createElement(SpeakingEvent, {
    key: i,
    event
  })))));
}
...
function About() {
  ...
  }, /* @__PURE__ */ React.createElement(import_react10.Icon, {
...
init_react();
var import_react11 = __toModule(require("@iconify/react"));
function Skill({ name, logo }) {
  ...
  }, logo && /* @__PURE__ */ React.createElement(import_react11.Icon, {
...
// app/components/Skills.tsx
var import_react12 = __toModule(require("@iconify/icons-logos/react"));
...
function useHashnodeArticles() {
  let [posts, setPosts] = (0, import_react13.useState)([]);
  let [page, setPage] = (0, import_react13.useState)(0);
  let [allBlogsFetched, setAllBlogsFetched] = (0, import_react13.useState)(false);
  ...
  const getMore = async () => {
    if (localStorage.getItem(DATA_LOCATION)) {
      ...
      const expiration = import_moment5.default.utc(cache.expires);
    ...
    const newSet = [...posts, ...response.posts].map((post) => __spreadProps(__spreadValues({}, post), { date: new Date(post.dateAdded) })).sort((a, b) => (0, import_moment5.default)(b.dateAdded) > (0, import_moment5.default)(a.dateAdded) ? 1 : 0);
    if (newSet.length >= response.total) {
      setAllBlogsFetched(true);
      localStorage.setItem(DATA_LOCATION, JSON.stringify({
        expires: import_moment5.default.utc().add(MINUTES_VALID, "minutes"),
        posts: newSet
      }));
    }
...
function Blog2() {
  ...
  let [filter, setFilter] = (0, import_react14.useState)("");
