...
export default function About() {
    ...
    return (
        <div id="top" className="md:min-h-screen w-screen justify-center">
            <div className="w-full md:w-8/12 bg-blue-900 dark:bg-gray-800 m-auto md:rounded-xl filter md:drop-shadow-dark-blue-solid-10 dark:md:drop-shadow-dark-blue-solid-5 p-8 md:p-16 flex flex-col relative">
            ...
            <div className="flex flex-col transition ease-in-out duration-300 items-center mt-4 md:mt-12 cursor-pointer transform hover:-translate-y-2" onClick={() => scrollToSection('skills')}>
                <h2 className="transition-all duration-300 text-blue-900 dark:text-cyan-900 text-2xl md:text-5xl font-bold font-PermanentMarker filter drop-shadow-dark-blue-solid-5">Check out what I use!</h2>
                <div className="mt-6" style={{ transform: 'rotate(108.21deg)', height: '4em', width: '4em'}}>
                    <Icon icon={arrowForwardThickFill} style={{ height: '4em', width: '4em'}} className="text-blue-900 dark:text-cyan-900"/>
                </div>
            </div>
        </div>
    )
