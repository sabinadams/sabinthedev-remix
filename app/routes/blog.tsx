        ...
        <BlogLayout>
            <div className="py-5 px-6 md:px-20 ">
                <div className="pb-10 text-center px-6 md:text-right md:px-6 flex flex-col md:flex-row">
                    <input type="text" className="w-full md:w-80 md:mb-0 mb-4 border-2 dark:border-none dark:placeholder:text-gray-300 dark:placeholder:opacity-20 rounded-lg p-2 dark:bg-gray-600 focus:outline-none focus:p-3 transition-all duration-300 ease-in-out" placeholder="Find something specific" onChange={e => setFilter(e.target.value)} />
                    <div className="flex-1"></div>
                    <h2 className="font-bold text-3xl transition duration-300 ease-in-out text-gray-700 dark:text-gray-300">{posts.length} Articles</h2>
                </div>
